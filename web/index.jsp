...
<body class="index-page">
  ...
  <header id="header" class="header d-flex align-items-center fixed-top">
    <div class="container-fluid container-xl position-relative d-flex align-items-center">
      ...
      <a href="indexs.jps" class="logo d-flex align-items-center me-auto">
        <img src="assets/img/logo.png" alt="">
        <h1 class="sitename">Music</h1>
      </a>
      ...
      <a class="btn-getstarted" href="login.jsp">
        <%= (userName != null && !userName.isEmpty()) ? "Dashboard" : "Login" %>
      </a>
    ...
    <section id="hero" class="hero section">
      ...
      <div class="container text-center">
        <div class="d-flex flex-column justify-content-center align-items-center">
          <h1 data-aos="fade-up">Welcome to <span>Music</span></h1>
          <p data-aos="fade-up" data-aos-delay="100">Your personalized music experience<br></p>
          <div class="d-flex" data-aos="fade-up" data-aos-delay="200">
            <a href="login.jsp" class="btn-get-started">Get Started</a>
          </div>
          <img src="assets/img/music-front.webp" class="img-fluid hero-img" alt="" data-aos="zoom-out" data-aos-delay="300">
        </div>
      </div>
    ...
    <div class="container footer-top">
      <div class="row gy-4">
        <div class="col-lg-4 col-md-6 footer-about">
          <a href="indexss.html" class="logo d-flex align-items-center">
