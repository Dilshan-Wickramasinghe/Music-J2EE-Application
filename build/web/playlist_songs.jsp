...
<html>
    ...
    <body>
        ...
        <div class="container">
            <h2 class="my-4"><%= playlistName %> (<%= size%>)</h2>
            <div class="form-group d-flex justify-content-end">
                ...
                <a href="/MusicJ2EE/playlists/songs/add/<%=playlistID%>" class="btn btn-primary">Add Songs</a>
            </div>
            <table class="table">
                <thead>
                    <tr>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="/MusicJ2EE/artists/songs/<%= song.getArtistId()%>"><%= song.getArtist()%></a></td>
                        <td><a href="/MusicJ2EE/artists/albums/<%= song.getAlbumId()%>"><%= song.getAlbum()%></a></td>
                        <td>
                        ...
                        <td>
                            <a href="/MusicJ2EE/playlists/songs/remove/<%= playlistID %>/<%= song.getId()%>" class="atag">
