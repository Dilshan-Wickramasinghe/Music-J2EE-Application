...
<%
    ...
    List<Song> songs = (List<Song>) request.getAttribute("songslist");
...
<html>
    ...
    <body>
        ...
        <div class="banner">
            ...
            <h4><%= request.getAttribute("artistName") %></h4>
        </div>
        <div class="container">
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="/MusicJ2EE/artists/albums/<%= song.getArtistId()%>"><%= song.getAlbum()%></a></td>
                        <td>
